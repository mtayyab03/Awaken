...
import SplasheScreen from './app/screens/SplasheScreen';
      ...
      <Tab.Screen
        ...
        options={route => ({
          tabBarIcon: ({ focused }) => (
            <View>
              {focused ?
                <LinearGradient colors={['#760BEE', '#DD3DFB']} start={[1, 1]} end={[0.2, 0.3]} style={focused && styles.activeIcon}>
                  <FontAwesomeIcon
                    name="home"
                    size={27}
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator headerMode="none" initialRouteName="SplashScreen">
        ...
        <Stack.Screen name="SplasheScreen" component={SplasheScreen} />
        <Stack.Screen name="OnboardingfirstScreen" component={OnboardingfirstScreen} />
        ...
        <Stack.Screen name="NightPlayOptionScreen" component={NightPlayOptionScreen} />
        <Stack.Screen name="WelcomeScreen" component={WelcomeScreen} />
        <Stack.Screen name="ChooseTopicScreen" component={ChooseTopicScreen} />
        <Stack.Screen name="WelcomeSleepScreen" component={WelcomeSleepScreen} />
