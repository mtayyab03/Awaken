...
import { Image, TouchableOpacity, StyleSheet, View, Text, Pressable, } from 'react-native'
...
export default function CalenderScreen(props) {
    ...
    return (
        <Screen style={{ flex: 1, justifyContent: 'flex-start', backgroundColor: Colors.lightWhite }}>
            ...
            {/* textview */}
            <View style={{ justifyContent: 'center', marginTop: RFPercentage(4), marginLeft: RFPercentage(3) }}>
                <Text style={{ color: '#0D1040D6', fontWeight: '600', fontSize: RFPercentage(3.5) }}>
                    What time would you {'\n'} like to meditate?
                </Text>
                <Text style={{ color: '#0D104080', fontWeight: '400', fontSize: RFPercentage(2.5), marginTop: RFPercentage(1) }}>
